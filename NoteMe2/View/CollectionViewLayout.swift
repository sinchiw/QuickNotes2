...
class CollectionViewLayout: UICollectionViewLayout, UICollectionViewDelegateFlowLayout {
...
//            let photoHeight = delegate.collectionView(collectionView, indexPath: indexPath)
            let height = cellPadding * 1
//                + photoHeight
